...
import com.bao.controller.msg.UploadResponse;
...
public class ProductController {
  ...
  private static final String PHOTO_PATH = "/Users/sl/Documents/SL/me/aixuManager/productImg/";

  @Autowired
  private ProductMapper mapper;

  @RequestMapping(value = "/upload", method = RequestMethod.POST)
  public Map<String, List<Map<String, Object>>> upload(MultipartHttpServletRequest request) {
  ...
  public ResponseEntity<?> saveOrUpdate(@RequestBody Product product) {
    ...
    try {
      ...
      if (StringUtils.isBlank(product.getPrice().toPlainString())
